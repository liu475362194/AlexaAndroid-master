...
public abstract class AbstractAudioRecorder implements AudioRecorder {
    ...
    private OnStopListeningListener stopListeningListener;

    public interface OnStopListeningListener{
        public void stopNow();
    }

    public void setOnStopListeningListener(OnStopListeningListener onStopListeningListener){
        stopListeningListener = onStopListeningListener;
    }
    ...
    protected AbstractAudioRecorder(int audioSource, int sampleRate) {
        ...
        mRecording = new byte[mOneSec * 10];
    }
    ...
    protected int read(SpeechRecord recorder, byte[] buffer) {
        ...
        Log.i("Pause score status: " + status);
        return status;
    }
    ...
    public boolean isTimeOut(){
        return read(mRecorder, mBuffer)<0;
    }
